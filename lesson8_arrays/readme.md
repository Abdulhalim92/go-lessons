...
### Удаление элемента из среза
    Удаление элемента из среза осуществляется с помощью функции delete:
```go
slice := []int{1, 2, 3, 4, 5}
delete(slice, 2) // удаление элемента с индексом 2
...
### Вставка элемента в срез
    Вставка элемента в срез осуществляется с помощью функции insert:
```go
slice := []int{1, 2, 3, 4, 5}
insert(slice, 2, 10) // вставка элемента с индексом 2
